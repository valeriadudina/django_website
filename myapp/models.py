...
class Preferences(models.Model):
    review = models.CharField("Заполни форму ниже", max_length=1000)
...
class Tinder(models.Model):
    ...
    type = models.CharField(max_length=200, choices=(('active', 'Активный'), ('culture', 'Культурно-познавательный'),
                                                     ...
                                                     ('beach', 'Пляжный'),))
    prefered_activities = MultiSelectField(choices=activities, max_length=1000)
    person_details = MultiSelectField(choices=person, max_length=1000)
...
class Tour(models.Model):
    ...
    days = models.PositiveIntegerField("Количество дней", default=1, blank=True)
